...
class Movie {
  ...
  static final List<Movie> listMovie = [
    Movie(
        ...
        description:
            ...
            ' la aniquilación.',
        reviews: 12,
        imageUrl: 'assets/img/mortal_kombat.jpg'),
    Movie(
        ...
        reviews: 66,
        imageUrl: 'assets/img/red_son.jpg'),
    Movie(
        ...
        reviews: 44,
        imageUrl: 'assets/img/apokolips_war.jpg'),
    Movie(
        title: 'Extraction',
        duration: Duration(hours: 2, minutes: 7),
        ...
        reviews: 44,
        imageUrl: 'assets/img/mision_rescate.jpg'),
  ];
  ...
  static final listMovie2 = [
    Movie(
        ...
        reviews: 54,
        imageUrl: 'assets/img/kissing_both.jpg'),
    Movie(
    ...
    Movie(
        ...
        reviews: 40,
        imageUrl: 'assets/img/bad_boys2.jpg'),
    Movie(
        ...
        description:
            ...
            'Skywalker a su fin.',
        reviews: 54,
        imageUrl: 'assets/img/star_wars.jpg'),
  ];
  ...
  static final listMovie3 = [
    Movie(
        ...
        reviews: 54,
        imageUrl: 'assets/img/jojo_rabbit.jpg'),
    Movie(
    ...
    Movie(
        ...
        reviews: 40,
        imageUrl: 'assets/img/onward.jpg'),
    Movie(
        title:
        ...
        reviews: 54,
        imageUrl: 'assets/img/bird_prey.jpg'),
  ];
}
