...
import 'package:movie_ticker/movie_ticker/pages/movie_detail.dart';
import 'package:movie_ticker/movie_ticker/pages/widgets/row_stars.dart';
...
class BillboardList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final heightBillboard = MediaQuery.of(context).size.height * .6;
    return Column(
